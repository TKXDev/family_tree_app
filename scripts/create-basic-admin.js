/**
 * Script to create a basic admin user in the database
 */
...
const connectDB = async () => {
  try {
    ...
    const adminUser = new User({
      ...
      role: "admin", // Basic admin role
    });

    await adminUser.save();
    console.log("Basic admin user created successfully:");
    console.log("Email: basicadmin@example.com");
